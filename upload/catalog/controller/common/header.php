...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$menu_side_image_link = $this->config->get('module_menu_side_image_link');

		if (!$menu_side_image) {
			$menu_side_image = 'catalog/banneri/bnr1.jpeg';
		}

		if (!$menu_side_image_link) {
			$menu_side_image_link = '/haljine';
		}
		...
		$data['menu_side_image_link'] = $menu_side_image_link;
