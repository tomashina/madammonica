<?php
	...
	if ($this->cache->get('basel_mandatory_css_store_' . $this->config->get('config_store_id'))) {
		...
		$search_height = round($this->config->get('menu_height_normal') * 0.5);
		$madatory_css .= '.full-search-wrapper .search-main input,.full-search-wrapper .search-category select {height:45px;min-height:45px;}';
