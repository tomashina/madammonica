...
class ControllerCommonDashboard extends Controller {
	public function index() {
		...
		$data['menu_side_image'] = $this->url->link('extension/module/menu_side_image', 'user_token=' . $this->session->data['user_token'], true);
		$data['button_menu_side_image'] = $this->language->get('button_menu_side_image');
