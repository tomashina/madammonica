<?php
	...
	in_array('all_custom_fields', $advpp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $custom_field_name['name'] . $csv_enclosed : '';
	}
	}	
	...
	in_array('all_custom_fields', $advpp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $custom_field['value'] . $csv_enclosed : '';
	}
	} else {
	foreach ($custom_fields_name as $custom_field_name) {
	in_array('all_custom_fields', $advpp_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	}
	}
