<?php
	...
	in_array('scw_category', $advpp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['categories']) . $csv_enclosed : '';
	in_array('scw_manufacturer', $advpp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['manufacturers']) . $csv_enclosed : '';
	...
	in_array('scw_price', $advpp_settings_scw_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . round($result['price_raw'], 2) . $csv_enclosed : '';	
	...
	in_array('pnp_category', $advpp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['categories']) . $csv_enclosed : '';
	in_array('pnp_manufacturer', $advpp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['manufacturers']) . $csv_enclosed : '';
	...
	in_array('pnp_price', $advpp_settings_pnp_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . round($result['price_raw'], 2) . $csv_enclosed : '';	
	...
	in_array('cm_sold_percent', $advpp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . ($result['sold_quantity'] != 0 ? round(100 * ($result['sold_quantity'] / $result['sold_quantity_total']), 2) : round((100), 2)) . '%' . $csv_enclosed : '';	
	in_array('cm_total_excl_vat', $advpp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . round($result['total_excl_vat_raw'], 2) . $csv_enclosed : '';
	in_array('cm_total_tax', $advpp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . round($result['total_tax_raw'], 2) . $csv_enclosed : '';
	in_array('cm_total_incl_vat', $advpp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . round($result['total_incl_vat_raw'], 2) . $csv_enclosed : '';
	in_array('cm_app', $advpp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . round($result['app_raw'], 2) . $csv_enclosed : '';
	in_array('cm_refunds', $advpp_settings_cm_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . round($result['refunds_raw'], 2) . $csv_enclosed : '';
	...
	in_array('mv_sold_percent', $advpp_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . ($result['sold_quantity'] != 0 ? round(100 * ($result['sold_quantity'] / $result['sold_quantity_total']), 2) : round((100), 2)) . '%' . $csv_enclosed : '';
