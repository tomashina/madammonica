...
class ControllerExtensionShippingUltimateShipping extends Controller {
	...
	public function index() {
		...
		// extension-specific
		$setting_override_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "setting WHERE (`code` IN (SELECT `code` FROM `" . DB_PREFIX . "extension` WHERE `type` = 'shipping') AND `code` != '" . $this->name . "') OR `key` = 'config_address' ORDER BY `code`, `key` ASC");
