...
<div><?php if (file_exists(DIR_APPLICATION . 'model/extension/module/adv_settings.php')) { include(DIR_APPLICATION . 'model/extension/module/adv_settings.php'); } else { echo $module_page; } ?></div>
...
<?php } ?>                
				<div class="well well-sm" style="background:#f5f5f5; height:200px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
...
<?php if ($filter_report == 'products_without_orders') { ?>        
		...
		<div id="checkbox_pnp_column" class="row">
			<div class="col-sm-12">
				<div class="well well-sm" style="background:#f5f5f5; height:160px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
...
<?php if ($filter_report == 'products_shopping_carts' or $filter_report == 'products_wishlists') { ?>        
		...
		<div id="checkbox_scw_column" class="row">
			<div class="col-sm-12">
				<div class="well well-sm" style="background:#f5f5f5; height:240px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
...
<?php if ($filter_report == 'products_purchased_without_options' or $filter_report == 'products_purchased_with_options' or $filter_report == 'new_products_purchased' or $filter_report == 'old_products_purchased' or $filter_report == 'products_abandoned_orders') { ?>                
				<div class="well well-sm" style="background:#f5f5f5; height:300px; overflow:auto;">
<?php } elseif ($filter_report == 'manufacturers' or $filter_report == 'categories' or $filter_report == 'products_options') { ?>
				<div class="well well-sm" style="background:#f5f5f5; height:320px; overflow:auto;">
<?php } ?>
<?php } ?>                
<?php if ($filter_report == 'products_purchased_without_options' or $filter_report == 'products_purchased_with_options' or $filter_report == 'new_products_purchased' or $filter_report == 'old_products_purchased' or $filter_report == 'products_abandoned_orders') { ?>
...
<?php if ($filter_report == 'products_purchased_without_options' or $filter_report == 'products_purchased_with_options' or $filter_report == 'new_products_purchased' or $filter_report == 'old_products_purchased' or $filter_report == 'products_options' or $filter_report == 'manufacturers' or $filter_report == 'categories' or $filter_report == 'products_abandoned_orders') { ?>      
		<div id="checkbox_all_column" class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:470px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
...
<?php } ?>
        ...
        <tr>
          ...
          <?php } ?>          
          <?php if (in_array('mv_sold_quantity', $advpp_settings_mv_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#E7EFEF; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#E7EFEF; color:#003A88;"' ?> ><strong><?php echo $product['sold_quantity_total']; ?></strong></td>
          <?php } ?>
          <?php if (in_array('mv_sold_percent', $advpp_settings_mv_columns)) { ?>          
          <td class="right" nowrap="nowrap" <?php echo ($filter_report == 'products_abandoned_orders') ? 'style="background-color:#E7EFEF; color:#003A88; text-decoration:line-through;"' : 'style="background-color:#E7EFEF; color:#003A88;"' ?> ><strong><?php echo $product['sold_percent_total']; ?></strong></td>
          <?php } ?>
          <?php if (in_array('mv_total_excl_vat', $advpp_settings_mv_columns)) { ?>          
