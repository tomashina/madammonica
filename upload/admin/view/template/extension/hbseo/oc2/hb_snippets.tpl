		     ...
		     <ul class="nav nav-tabs">
			  ...
			  <div class="tab-content">
					 ...
					 <div class="tab-pane active" id="tab-sd">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Breadcrumb Structure Type</label>
								<div class="col-sm-9">
									<select name="hb_snippets_bc_type" class="form-control">
										<option value="smart" <?php echo ($hb_snippets_bc_type == 'smart')? 'selected':''; ?>>SEO Smart</option>
										<option value="original" <?php echo ($hb_snippets_bc_type == 'original')? 'selected':''; ?>>Original</option>
									</select>
								</div>
							</div>
				    ...
				    <div class="tab-pane" id="tab-og">
						<div class="well">
								...
								<p><a class="btn btn-sm btn-success" href="https://developers.facebook.com/tools/debug/" target="_blank"><i class="fa fa-facebook-official"></i> Open Graph Debugger Tool</a></p>
						</div>
